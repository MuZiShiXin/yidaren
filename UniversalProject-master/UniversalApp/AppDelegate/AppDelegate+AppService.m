...
#pragma mark ————— 初始化融云客服 —————
- (void)initRCIM:(UIApplication *)application
{
...
-(void)configUSharePlatforms{
    ...
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:kAppKey_Tencent/*设置微博*/  appSecret:nil redirectURL:nil];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Qzone appKey:kAppKey_Tencent /*设置QQ空间*/appSecret:nil redirectURL:nil];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Email/*Email*/ appKey:kAppKey_Tencent appSecret:nil redirectURL:nil];
