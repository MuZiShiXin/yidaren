...
-(void)updateNavigationItems{
    if (_isShowCloseBtn) {
        if (self.webView.canGoBack) {
            ...
            [self addNavigationItemWithImageNames:@[@"yg_dhl_tb1",@"close_icon"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2000,@2001]];
            ...
            if (kiOS9Later) {
                ...
                [self addNavigationItemWithImageNames:@[@"yg_dhl_tb1"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2001]];
            }
        }
    }
}
