...
{
    [self addNavigationItemWithImageNames:@[@"ygdr_sy_dhl_tb2"] isLeft:NO target:self action:@selector(naviBtnClick:)  tags:@[@2000]];
    
    
    UIView *firstview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, 337/2)];
...
-(void)naviBtnClick:(UIButton *)btn{
    DLog(@"点击了消息");
    XiaoXiMoKuaiViewController *DetailVC = [[XiaoXiMoKuaiViewController alloc]init];
    [self.navigationController pushViewController:DetailVC animated:YES];
}
