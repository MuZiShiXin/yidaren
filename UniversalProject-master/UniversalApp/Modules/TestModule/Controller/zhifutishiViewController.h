...
@interface zhifutishiViewController : RootViewController
...
@property (strong, nonatomic) IBOutlet UILabel *gongrenxingmingLabel;
@property (strong, nonatomic) IBOutlet UILabel *tishineirongLabel;
