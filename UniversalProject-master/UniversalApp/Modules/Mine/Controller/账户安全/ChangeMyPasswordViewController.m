...
@property (strong, nonatomic) IBOutlet UILabel *shoujihao;
...
- (void)viewDidLoad {
    ...
    _qingshuryanzhengma.keyboardType =  UIKeyboardTypeNumberPad;
...
- (IBAction)querenxiugai {
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(userManager.curUserInfo.userInfoId),@"userInfoId",userManager.curUserInfo.userName,"phone", _qingshurumima.text,@"password",_qingshuryanzhengma.text,@"phoneVerCode",@(2),@"type", nil];
