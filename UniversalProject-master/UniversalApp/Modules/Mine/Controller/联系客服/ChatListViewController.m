...
-(void)viewDidLoad
{
    ...
    UIImageView *backImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"yg_dhl_tb1"]];
    backImg.frame = CGRectMake(-10, 5, 22, 22);
    [backBtn addSubview:backImg];
    UILabel *backText = [[UILabel alloc] initWithFrame:CGRectMake(15, 5, 65, 22)];
    backText.text = @"退出";
