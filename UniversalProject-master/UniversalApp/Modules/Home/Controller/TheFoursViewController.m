...
@interface TheFoursViewController ()<UITableViewDelegate,UITableViewDataSource,BMKLocationServiceDelegate>
...
@implementation TheFoursViewController
...
- (void)httpRequest
{
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(userManager.curUserInfo.userInfoId),@"userInfoId",@(_CoutPage),@"currentPage",@(4),@"orderType",@(10),@"pageSize",@(_locService.userLocation.location.coordinate.longitude),@"x",@(_locService.userLocation.location.coordinate.latitude),@"y", nil];
