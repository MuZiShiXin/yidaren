...
@interface TheTwoSViewController ()<UITableViewDelegate,UITableViewDataSource,BMKLocationServiceDelegate>
...
@implementation TheTwoSViewController
...
- (void)httpRequest
{
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(userManager.curUserInfo.userInfoId),@"userInfoId",@(_CoutPage),@"currentPage",@(2),@"orderType",@(10),@"pageSize",@(_locService.userLocation.location.coordinate.longitude),@"x",@(_locService.userLocation.location.coordinate.latitude),@"y", nil];
