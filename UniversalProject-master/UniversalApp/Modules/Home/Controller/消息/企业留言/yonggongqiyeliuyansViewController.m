//
//  yonggongqiyeliuyansViewController.m
//  UniversalApp
//
...
@interface yonggongqiyeliuyansViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation yonggongqiyeliuyansViewController
...
- (void)httpRequest
{
   ...
   NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(userManager.curUserInfo.userInfoId),@"userDrId",@(4),@"messagetype", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    qiyeyonggongliuyanSTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    //根据标示去找cell，如果有现成的就用现成的
    if (!cell) {
        //没有现成的cell的时候：
        cell = [[[NSBundle mainBundle]loadNibNamed:@"qiyeyonggongliuyanSTableViewCell" owner:nil options:nil] firstObject];
    }
