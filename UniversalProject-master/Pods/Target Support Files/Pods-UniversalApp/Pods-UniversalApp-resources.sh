...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "LFMediaEditingController/LFMediaEditingController/class/common/LFMediaEditingController.bundle"
  ...
  install_resource "YMCitySelect/YMCitySelect/YMCitySelect.bundle"
fi
